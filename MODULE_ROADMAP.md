...
(Website Mode не потребує зв'язків між вузлами — стане потрібним з
Diagram Mode/KG Visualization, наступного кроку). Наступні кроки за
планом: KG Visualization (Diagram Mode) → Live Objects (iframe) →
Components/Brand Kit → Smart Components → AI Creator → ... —
