...
const FAQS: Record<Locale, Array<{ q: string; a: string }>> = {
  uk: [
    {
      q: "Чи потрібно платити за API Google (GSC / GA4)?",
      a: "Ні, інтеграція підключається через OAuth за пару кліків і абсолютно безкоштовна.",
    },
    {
      q: "Чи можу я надсилати звіти під своїм брендом?",
      a: "Так, на тарифах Growth і Agency ви додаєте свій логотип, назву студії й кастомний футер до кожного PDF-звіту.",
    },
    {
      q: "Що якщо у мене тільки 1 сайт?",
      a: "Можете користуватись Free-планом назавжди для моніторингу власного проєкту — без картки й без обмеження в часі.",
    },
    {
      q: "Чи потрібен доступ до хостингу або коду сайту клієнта?",
      a: "Ні. Qorax працює зовні — як відвідувач сайту. Достатньо вказати URL. Доступ до файлів сайту не потрібен.",
    },
    {
      q: "Як рахується «втрата у $» від проблеми?",
      a: "AI оцінює вплив на основі типового падіння конверсії при подібній проблемі (наприклад, повільне завантаження) та середнього трафіку сайту. Це орієнтовна оцінка для розмови з клієнтом, не бухгалтерська точність.",
    },
    {
