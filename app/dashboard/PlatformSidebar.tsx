...
import {
  ...
  GraduationCap, Target, ChevronDown, Grid2x2, ArrowUpRight, Languages, ShoppingCart,
} from "lucide-react";
import type { PlatformModule } from "@/app/lib/getPlatformModules";

const ICONS: Record<string, React.ComponentType<{ size?: number; className?: string }>> = {
  ShieldCheck, Layout, Sparkles, FileText, TrendingUp, BarChart3, Users, Send, GraduationCap, Target, Languages, ShoppingCart,
};
